...
function testBasicImport() {
  ...
  try {
    ...
    runCommand('node -e "import(\'./index.js\').then(m => console.log(\'ES import:\', Object.keys(m)))"', 'ES module import test');
    
    // Test CommonJS require
    runCommand('node -e "const m = require(\'./index.cjs\'); console.log(\'CJS require:\', Object.keys(m))"', 'CommonJS require test');
